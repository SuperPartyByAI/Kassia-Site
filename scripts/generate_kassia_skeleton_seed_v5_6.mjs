...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preflight_v5_6.json'), JSON.stringify(preflightData, null, 2));

let preflightMd = `# Kassia Seed Preflight V5.6\n\n`;
...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preflight_v5_6.md'), preflightMd);
...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preview_from_skeleton_v5_6.json'), JSON.stringify(previewData, null, 2));

let mdContent = `# Kassia Seed Preview V5.6 (169 Pages)\n\n`;
...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preview_from_skeleton_v5_6.md'), mdContent);

// Generate SQL 04_seed_kassia_skeleton_preview_v5_6.sql

let sqlOut = `-- SEED SKELETON PREVIEW PENTRU KASSIA V5.6 (169 PAGES)\n`;
...
fs.writeFileSync(path.join(dbDir, '04_seed_kassia_skeleton_preview_v5_6.sql'), sqlOut);


console.log(JSON.stringify(previewData.summary, null, 2));
fs.writeFileSync(path.join(docsDir, 'kassia_internal_link_graph_v5_6.json'), JSON.stringify(links, null, 2));
