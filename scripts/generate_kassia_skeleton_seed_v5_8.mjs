...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preview_from_skeleton_v5_8.json'), JSON.stringify(previewData, null, 2));

// Generate SQL 04_seed_kassia_skeleton_preview_v5_8.sql
let sqlOut = `-- SEED SKELETON PREVIEW PENTRU KASSIA V5.8 (169 PAGES)\n`;
...
fs.writeFileSync(path.join(dbDir, '04_seed_kassia_skeleton_preview_v5_8.sql'), sqlOut);
