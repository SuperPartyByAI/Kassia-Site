...
http.get("http://127.0.0.1:9222/json/version", (res) => {
  ...
  res.on("end", async () => {
    try {
      ...
      console.log("Found Supabase tab. Starting chunk execution...");

      for (let i = 1; i <= 10; i++) {
          const sql = fs.readFileSync(`db/chunk_${i}.sql`, 'utf8');
          console.log(`Executing chunk ${i}/10...`);
          ...
          if (!clicked) {
             console.log("Run button not found! Falling back to Cmd+Enter...");
             await page.keyboard.down('Meta');
             await page.keyboard.press('Enter');
             await page.keyboard.up('Meta');
          }
          
          // Wait 5 seconds for chunk to execute
          await new Promise(r => setTimeout(r, 6000));
          console.log(`Chunk ${i} executed.`);
      }
      
      console.log("All chunks executed!");
