-- ============================================================================
-- 1. CLEANUP (Ștergem funcțiile create greșit de AI pentru a nu polua Zouka)
-- ============================================================================
DROP FUNCTION IF EXISTS get_sitemap_entries(text);
DROP FUNCTION IF EXISTS get_robots_meta(uuid);
DROP FUNCTION IF EXISTS unpublish_page(uuid);
DROP FUNCTION IF EXISTS publish_page(uuid);
DROP FUNCTION IF EXISTS get_canonical_url(uuid, text);
