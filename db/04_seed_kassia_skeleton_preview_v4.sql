-- SEED SKELETON PREVIEW PENTRU KASSIA V4 (169 PAGES)
-- GENERATED VIA SCRIPT.

BEGIN;

-- SAFE SCHEMA UPDATES (with preflight built-in)
DO $$
BEGIN
    ...
    -- Make image_url and alt_text nullable if they exist
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='kassia_gallery_items' AND column_name='image_url' AND is_nullable='NO') THEN
        ALTER TABLE kassia_gallery_items ALTER COLUMN image_url DROP NOT NULL;
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='kassia_gallery_items' AND column_name='alt_text' AND is_nullable='NO') THEN
        ALTER TABLE kassia_gallery_items ALTER COLUMN alt_text DROP NOT NULL;
    END IF;
    ...
    -- kassia_page_sections(page_id, section_key)
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'unique_page_section') THEN
        IF EXISTS (SELECT page_id, section_key FROM kassia_page_sections GROUP BY page_id, section_key HAVING COUNT(*) > 1) THEN
            RAISE EXCEPTION 'Duplicates found in kassia_page_sections. Cannot add constraint.';
        END IF;
        ALTER TABLE kassia_page_sections ADD CONSTRAINT unique_page_section UNIQUE(page_id, section_key);
    END IF;

    -- kassia_faqs(page_id, sort_order)
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'unique_page_faq') THEN
        IF EXISTS (SELECT page_id, sort_order FROM kassia_faqs GROUP BY page_id, sort_order HAVING COUNT(*) > 1) THEN
            RAISE EXCEPTION 'Duplicates found in kassia_faqs. Cannot add constraint.';
        END IF;
        ALTER TABLE kassia_faqs ADD CONSTRAINT unique_page_faq UNIQUE(page_id, sort_order);
    END IF;

    -- kassia_gallery_items(page_id, slot_key)
    ...
    -- kassia_internal_links(source_page_id, target_page_id, anchor_text)
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'kassia_internal_links_source_page_id_target_page_id_anchor__key') THEN
        ...
        END IF;
        -- Add the constraint explicitly if it somehow doesn't exist
...
BEGIN
    ...
    -- PAGE: /
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('home', '/', 'homepage', 'Homepage', 'Homepage', 'Homepage - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'agentie decoratiuni baloane bucuresti', 'commercial')
    ...
    VALUES (v_page_id, 'Draft FAQ 1 for home', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for home', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for home', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'gallery_1', 'Kassia Content Team', false, 2)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'gallery_2', 'Kassia Content Team', false, 3)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'gallery_3', 'Kassia Content Team', false, 4)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;

    -- PAGE: /despre-noi/
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('despre-noi', '/despre-noi/', 'support', 'Despre Noi', 'Despre Noi', 'Despre Noi - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'despre noi', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    -- PAGE: /contact/
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('contact', '/contact/', 'support', 'Contact', 'Contact', 'Contact - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'contact', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    -- PAGE: /galerie/
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('galerie', '/galerie/', 'support', 'Galerie', 'Galerie', 'Galerie - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'galerie', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('preturi-decoratiuni-baloane', '/preturi-decoratiuni-baloane/', 'support', 'Preturi Decoratiuni Baloane', 'Preturi Decoratiuni Baloane', 'Preturi Decoratiuni Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'preturi decoratiuni baloane', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('intrebari-frecvente', '/intrebari-frecvente/', 'support', 'Intrebari Frecvente', 'Intrebari Frecvente', 'Intrebari Frecvente - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'intrebari frecvente', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    -- PAGE: /recenzii/
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('recenzii', '/recenzii/', 'support', 'Recenzii', 'Recenzii', 'Recenzii - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'recenzii', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('portofoliu-evenimente', '/portofoliu-evenimente/', 'support', 'Portofoliu Evenimente', 'Portofoliu Evenimente', 'Portofoliu Evenimente - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'portofoliu evenimente', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('termeni-si-conditii', '/termeni-si-conditii/', 'support', 'Termeni Si Conditii', 'Termeni Si Conditii', 'Termeni Si Conditii - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'termeni si conditii', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('politica-de-confidentialitate', '/politica-de-confidentialitate/', 'support', 'Politica De Confidentialitate', 'Politica De Confidentialitate', 'Politica De Confidentialitate - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'politica de confidentialitate', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    -- PAGE: /blog/
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blog', '/blog/', 'support', 'Blog', 'Blog', 'Blog - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'blog', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('politica-cookies', '/politica-cookies/', 'support', 'Politica Cookies', 'Politica Cookies', 'Politica Cookies - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'politica cookies', 'navigational')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-bucuresti', '/decoratiuni-baloane-bucuresti/', 'service_pillar', 'Decoratiuni Baloane Bucuresti', 'Decoratiuni Baloane Bucuresti', 'Decoratiuni Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('aranjamente-baloane-bucuresti', '/aranjamente-baloane-bucuresti/', 'service', 'Aranjamente Baloane Bucuresti', 'Aranjamente Baloane Bucuresti', 'Aranjamente Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'aranjamente baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for aranjamente-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for aranjamente-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for aranjamente-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('arcada-baloane-bucuresti', '/arcada-baloane-bucuresti/', 'service', 'Arcada Baloane Bucuresti', 'Arcada Baloane Bucuresti', 'Arcada Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'arcada baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for arcada-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for arcada-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for arcada-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('baloane-heliu-bucuresti', '/baloane-heliu-bucuresti/', 'service', 'Baloane Heliu Bucuresti', 'Baloane Heliu Bucuresti', 'Baloane Heliu Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane heliu bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for baloane-heliu-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for baloane-heliu-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for baloane-heliu-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('panou-foto-baloane-bucuresti', '/panou-foto-baloane-bucuresti/', 'service', 'Panou Foto Baloane Bucuresti', 'Panou Foto Baloane Bucuresti', 'Panou Foto Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'panou foto baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for panou-foto-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for panou-foto-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for panou-foto-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('buchete-baloane-bucuresti', '/buchete-baloane-bucuresti/', 'service', 'Buchete Baloane Bucuresti', 'Buchete Baloane Bucuresti', 'Buchete Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'buchete baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for buchete-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for buchete-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for buchete-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('baloane-personalizate-bucuresti', '/baloane-personalizate-bucuresti/', 'service', 'Baloane Personalizate Bucuresti', 'Baloane Personalizate Bucuresti', 'Baloane Personalizate Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane personalizate bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for baloane-personalizate-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for baloane-personalizate-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for baloane-personalizate-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('baloane-cifre-litere-bucuresti', '/baloane-cifre-litere-bucuresti/', 'service', 'Baloane Cifre Litere Bucuresti', 'Baloane Cifre Litere Bucuresti', 'Baloane Cifre Litere Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane cifre litere bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for baloane-cifre-litere-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for baloane-cifre-litere-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for baloane-cifre-litere-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('ghirlande-baloane-bucuresti', '/ghirlande-baloane-bucuresti/', 'service', 'Ghirlande Baloane Bucuresti', 'Ghirlande Baloane Bucuresti', 'Ghirlande Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'ghirlande baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for ghirlande-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for ghirlande-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for ghirlande-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('stalpi-baloane-bucuresti', '/stalpi-baloane-bucuresti/', 'service', 'Stalpi Baloane Bucuresti', 'Stalpi Baloane Bucuresti', 'Stalpi Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'stalpi baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for stalpi-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for stalpi-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for stalpi-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('perete-baloane-bucuresti', '/perete-baloane-bucuresti/', 'service', 'Perete Baloane Bucuresti', 'Perete Baloane Bucuresti', 'Perete Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'perete baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for perete-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for perete-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for perete-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decor-baloane-candy-bar-bucuresti', '/decor-baloane-candy-bar-bucuresti/', 'service', 'Decor Baloane Candy Bar Bucuresti', 'Decor Baloane Candy Bar Bucuresti', 'Decor Baloane Candy Bar Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decor baloane candy bar bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decor-baloane-candy-bar-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decor-baloane-candy-bar-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decor-baloane-candy-bar-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('livrare-baloane-bucuresti', '/livrare-baloane-bucuresti/', 'service', 'Livrare Baloane Bucuresti', 'Livrare Baloane Bucuresti', 'Livrare Baloane Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'livrare baloane bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for livrare-baloane-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for livrare-baloane-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for livrare-baloane-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-botez-bucuresti', '/decoratiuni-baloane-botez-bucuresti/', 'event', 'Decoratiuni Baloane Botez Bucuresti', 'Decoratiuni Baloane Botez Bucuresti', 'Decoratiuni Baloane Botez Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane botez bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-botez-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-botez-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-botez-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-mot-bucuresti', '/decoratiuni-baloane-mot-bucuresti/', 'event', 'Decoratiuni Baloane Mot Bucuresti', 'Decoratiuni Baloane Mot Bucuresti', 'Decoratiuni Baloane Mot Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane mot bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-mot-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-mot-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-mot-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-turta-bucuresti', '/decoratiuni-baloane-turta-bucuresti/', 'event', 'Decoratiuni Baloane Turta Bucuresti', 'Decoratiuni Baloane Turta Bucuresti', 'Decoratiuni Baloane Turta Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane turta bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-turta-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-turta-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-turta-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-nunta-bucuresti', '/decoratiuni-baloane-nunta-bucuresti/', 'event', 'Decoratiuni Baloane Nunta Bucuresti', 'Decoratiuni Baloane Nunta Bucuresti', 'Decoratiuni Baloane Nunta Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane nunta bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-nunta-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-nunta-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-nunta-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-8-martie-bucuresti', '/decoratiuni-baloane-8-martie-bucuresti/', 'event', 'Decoratiuni Baloane 8 Martie Bucuresti', 'Decoratiuni Baloane 8 Martie Bucuresti', 'Decoratiuni Baloane 8 Martie Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane 8 martie bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-8-martie-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-8-martie-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-8-martie-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-cununie-bucuresti', '/decoratiuni-baloane-cununie-bucuresti/', 'event', 'Decoratiuni Baloane Cununie Bucuresti', 'Decoratiuni Baloane Cununie Bucuresti', 'Decoratiuni Baloane Cununie Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane cununie bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-cununie-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-cununie-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-cununie-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-majorat-bucuresti', '/decoratiuni-baloane-majorat-bucuresti/', 'event', 'Decoratiuni Baloane Majorat Bucuresti', 'Decoratiuni Baloane Majorat Bucuresti', 'Decoratiuni Baloane Majorat Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane majorat bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-majorat-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-majorat-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-majorat-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-aniversare-copii-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-aniversare-copii-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-aniversare-copii-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-aniversare-adulti-bucuresti', '/decoratiuni-baloane-aniversare-adulti-bucuresti/', 'event', 'Decoratiuni Baloane Aniversare Adulti Bucuresti', 'Decoratiuni Baloane Aniversare Adulti Bucuresti', 'Decoratiuni Baloane Aniversare Adulti Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane aniversare adulti bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-aniversare-adulti-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-aniversare-adulti-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-aniversare-adulti-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-petrecere-bucuresti', '/decoratiuni-baloane-petrecere-bucuresti/', 'event', 'Decoratiuni Baloane Petrecere Bucuresti', 'Decoratiuni Baloane Petrecere Bucuresti', 'Decoratiuni Baloane Petrecere Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane petrecere bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-petrecere-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-petrecere-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-petrecere-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-corporate-bucuresti', '/decoratiuni-baloane-corporate-bucuresti/', 'event', 'Decoratiuni Baloane Corporate Bucuresti', 'Decoratiuni Baloane Corporate Bucuresti', 'Decoratiuni Baloane Corporate Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane corporate bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-corporate-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-corporate-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-corporate-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-deschidere-magazin-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-deschidere-magazin-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-deschidere-magazin-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-deschidere-restaurant-bucuresti', '/decoratiuni-baloane-deschidere-restaurant-bucuresti/', 'event', 'Decoratiuni Baloane Deschidere Restaurant Bucuresti', 'Decoratiuni Baloane Deschidere Restaurant Bucuresti', 'Decoratiuni Baloane Deschidere Restaurant Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane deschidere restaurant bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-deschidere-restaurant-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-deschidere-restaurant-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-deschidere-restaurant-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-lansare-produs-bucuresti', '/decoratiuni-baloane-lansare-produs-bucuresti/', 'event', 'Decoratiuni Baloane Lansare Produs Bucuresti', 'Decoratiuni Baloane Lansare Produs Bucuresti', 'Decoratiuni Baloane Lansare Produs Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane lansare produs bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-lansare-produs-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-lansare-produs-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-lansare-produs-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-showroom-bucuresti', '/decoratiuni-baloane-showroom-bucuresti/', 'event', 'Decoratiuni Baloane Showroom Bucuresti', 'Decoratiuni Baloane Showroom Bucuresti', 'Decoratiuni Baloane Showroom Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane showroom bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-showroom-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-showroom-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-showroom-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-gradinita-bucuresti', '/decoratiuni-baloane-gradinita-bucuresti/', 'event', 'Decoratiuni Baloane Gradinita Bucuresti', 'Decoratiuni Baloane Gradinita Bucuresti', 'Decoratiuni Baloane Gradinita Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane gradinita bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-gradinita-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-gradinita-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-gradinita-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-scoala-bucuresti', '/decoratiuni-baloane-scoala-bucuresti/', 'event', 'Decoratiuni Baloane Scoala Bucuresti', 'Decoratiuni Baloane Scoala Bucuresti', 'Decoratiuni Baloane Scoala Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane scoala bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-scoala-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-scoala-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-scoala-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-baby-shower-bucuresti', '/decoratiuni-baloane-baby-shower-bucuresti/', 'event', 'Decoratiuni Baloane Baby Shower Bucuresti', 'Decoratiuni Baloane Baby Shower Bucuresti', 'Decoratiuni Baloane Baby Shower Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane baby shower bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-baby-shower-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-baby-shower-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-baby-shower-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-gender-reveal-bucuresti', '/decoratiuni-baloane-gender-reveal-bucuresti/', 'event', 'Decoratiuni Baloane Gender Reveal Bucuresti', 'Decoratiuni Baloane Gender Reveal Bucuresti', 'Decoratiuni Baloane Gender Reveal Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane gender reveal bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-gender-reveal-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-gender-reveal-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-gender-reveal-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-craciun-bucuresti', '/decoratiuni-baloane-craciun-bucuresti/', 'event', 'Decoratiuni Baloane Craciun Bucuresti', 'Decoratiuni Baloane Craciun Bucuresti', 'Decoratiuni Baloane Craciun Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane craciun bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-craciun-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-craciun-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-craciun-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-revelion-bucuresti', '/decoratiuni-baloane-revelion-bucuresti/', 'event', 'Decoratiuni Baloane Revelion Bucuresti', 'Decoratiuni Baloane Revelion Bucuresti', 'Decoratiuni Baloane Revelion Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane revelion bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-revelion-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-revelion-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-revelion-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-paste-bucuresti', '/decoratiuni-baloane-paste-bucuresti/', 'event', 'Decoratiuni Baloane Paste Bucuresti', 'Decoratiuni Baloane Paste Bucuresti', 'Decoratiuni Baloane Paste Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane paste bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-paste-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-paste-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-paste-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-halloween-bucuresti', '/decoratiuni-baloane-halloween-bucuresti/', 'event', 'Decoratiuni Baloane Halloween Bucuresti', 'Decoratiuni Baloane Halloween Bucuresti', 'Decoratiuni Baloane Halloween Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane halloween bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-halloween-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-halloween-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-halloween-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-1-iunie-bucuresti', '/decoratiuni-baloane-1-iunie-bucuresti/', 'event', 'Decoratiuni Baloane 1 Iunie Bucuresti', 'Decoratiuni Baloane 1 Iunie Bucuresti', 'Decoratiuni Baloane 1 Iunie Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane 1 iunie bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-1-iunie-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-1-iunie-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-1-iunie-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-absolvire-bucuresti', '/decoratiuni-baloane-absolvire-bucuresti/', 'event', 'Decoratiuni Baloane Absolvire Bucuresti', 'Decoratiuni Baloane Absolvire Bucuresti', 'Decoratiuni Baloane Absolvire Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane absolvire bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-absolvire-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-absolvire-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-absolvire-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-sector-1', '/decoratiuni-baloane-sector-1/', 'location', 'Decoratiuni Baloane Sector 1', 'Decoratiuni Baloane Sector 1', 'Decoratiuni Baloane Sector 1 - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane sector 1', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-sector-1', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-sector-1', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-sector-1', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-sector-2', '/decoratiuni-baloane-sector-2/', 'location', 'Decoratiuni Baloane Sector 2', 'Decoratiuni Baloane Sector 2', 'Decoratiuni Baloane Sector 2 - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane sector 2', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-sector-2', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-sector-2', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-sector-2', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-sector-3', '/decoratiuni-baloane-sector-3/', 'location', 'Decoratiuni Baloane Sector 3', 'Decoratiuni Baloane Sector 3', 'Decoratiuni Baloane Sector 3 - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane sector 3', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-sector-3', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-sector-3', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-sector-3', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-sector-4', '/decoratiuni-baloane-sector-4/', 'location', 'Decoratiuni Baloane Sector 4', 'Decoratiuni Baloane Sector 4', 'Decoratiuni Baloane Sector 4 - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane sector 4', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-sector-4', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-sector-4', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-sector-4', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-sector-5', '/decoratiuni-baloane-sector-5/', 'location', 'Decoratiuni Baloane Sector 5', 'Decoratiuni Baloane Sector 5', 'Decoratiuni Baloane Sector 5 - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane sector 5', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-sector-5', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-sector-5', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-sector-5', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-sector-6', '/decoratiuni-baloane-sector-6/', 'location', 'Decoratiuni Baloane Sector 6', 'Decoratiuni Baloane Sector 6', 'Decoratiuni Baloane Sector 6 - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane sector 6', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-sector-6', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-sector-6', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-sector-6', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-aviatiei', '/decoratiuni-baloane-aviatiei/', 'location', 'Decoratiuni Baloane Aviatiei', 'Decoratiuni Baloane Aviatiei', 'Decoratiuni Baloane Aviatiei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane aviatiei', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-aviatiei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-aviatiei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-aviatiei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-baneasa', '/decoratiuni-baloane-baneasa/', 'location', 'Decoratiuni Baloane Baneasa', 'Decoratiuni Baloane Baneasa', 'Decoratiuni Baloane Baneasa - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane baneasa', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-baneasa', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-baneasa', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-baneasa', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-domenii', '/decoratiuni-baloane-domenii/', 'location', 'Decoratiuni Baloane Domenii', 'Decoratiuni Baloane Domenii', 'Decoratiuni Baloane Domenii - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane domenii', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-domenii', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-domenii', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-domenii', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-herastrau', '/decoratiuni-baloane-herastrau/', 'location', 'Decoratiuni Baloane Herastrau', 'Decoratiuni Baloane Herastrau', 'Decoratiuni Baloane Herastrau - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane herastrau', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-herastrau', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-herastrau', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-herastrau', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-victoriei', '/decoratiuni-baloane-victoriei/', 'location', 'Decoratiuni Baloane Victoriei', 'Decoratiuni Baloane Victoriei', 'Decoratiuni Baloane Victoriei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane victoriei', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-victoriei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-victoriei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-victoriei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-colentina', '/decoratiuni-baloane-colentina/', 'location', 'Decoratiuni Baloane Colentina', 'Decoratiuni Baloane Colentina', 'Decoratiuni Baloane Colentina - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane colentina', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-colentina', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-colentina', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-colentina', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-obor', '/decoratiuni-baloane-obor/', 'location', 'Decoratiuni Baloane Obor', 'Decoratiuni Baloane Obor', 'Decoratiuni Baloane Obor - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane obor', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-obor', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-obor', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-obor', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-pantelimon', '/decoratiuni-baloane-pantelimon/', 'location', 'Decoratiuni Baloane Pantelimon', 'Decoratiuni Baloane Pantelimon', 'Decoratiuni Baloane Pantelimon - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane pantelimon', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-pantelimon', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-pantelimon', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-pantelimon', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-tei', '/decoratiuni-baloane-tei/', 'location', 'Decoratiuni Baloane Tei', 'Decoratiuni Baloane Tei', 'Decoratiuni Baloane Tei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane tei', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-tei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-tei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-tei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-stefan-cel-mare', '/decoratiuni-baloane-stefan-cel-mare/', 'location', 'Decoratiuni Baloane Stefan Cel Mare', 'Decoratiuni Baloane Stefan Cel Mare', 'Decoratiuni Baloane Stefan Cel Mare - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane stefan cel mare', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-stefan-cel-mare', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-stefan-cel-mare', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-stefan-cel-mare', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-dristor', '/decoratiuni-baloane-dristor/', 'location', 'Decoratiuni Baloane Dristor', 'Decoratiuni Baloane Dristor', 'Decoratiuni Baloane Dristor - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane dristor', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-dristor', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-dristor', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-dristor', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-titan', '/decoratiuni-baloane-titan/', 'location', 'Decoratiuni Baloane Titan', 'Decoratiuni Baloane Titan', 'Decoratiuni Baloane Titan - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane titan', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-titan', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-titan', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-titan', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-vitan', '/decoratiuni-baloane-vitan/', 'location', 'Decoratiuni Baloane Vitan', 'Decoratiuni Baloane Vitan', 'Decoratiuni Baloane Vitan - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane vitan', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-vitan', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-vitan', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-vitan', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-unirii', '/decoratiuni-baloane-unirii/', 'location', 'Decoratiuni Baloane Unirii', 'Decoratiuni Baloane Unirii', 'Decoratiuni Baloane Unirii - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane unirii', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-unirii', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-unirii', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-unirii', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-dudesti', '/decoratiuni-baloane-dudesti/', 'location', 'Decoratiuni Baloane Dudesti', 'Decoratiuni Baloane Dudesti', 'Decoratiuni Baloane Dudesti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane dudesti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-dudesti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-dudesti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-dudesti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-berceni', '/decoratiuni-baloane-berceni/', 'location', 'Decoratiuni Baloane Berceni', 'Decoratiuni Baloane Berceni', 'Decoratiuni Baloane Berceni - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane berceni', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-berceni', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-berceni', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-berceni', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-tineretului', '/decoratiuni-baloane-tineretului/', 'location', 'Decoratiuni Baloane Tineretului', 'Decoratiuni Baloane Tineretului', 'Decoratiuni Baloane Tineretului - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane tineretului', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-tineretului', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-tineretului', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-tineretului', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-piata-sudului', '/decoratiuni-baloane-piata-sudului/', 'location', 'Decoratiuni Baloane Piata Sudului', 'Decoratiuni Baloane Piata Sudului', 'Decoratiuni Baloane Piata Sudului - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane piata sudului', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-piata-sudului', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-piata-sudului', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-piata-sudului', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-aparatorii-patriei', '/decoratiuni-baloane-aparatorii-patriei/', 'location', 'Decoratiuni Baloane Aparatorii Patriei', 'Decoratiuni Baloane Aparatorii Patriei', 'Decoratiuni Baloane Aparatorii Patriei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane aparatorii patriei', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-aparatorii-patriei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-aparatorii-patriei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-aparatorii-patriei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-oltenitei', '/decoratiuni-baloane-oltenitei/', 'location', 'Decoratiuni Baloane Oltenitei', 'Decoratiuni Baloane Oltenitei', 'Decoratiuni Baloane Oltenitei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane oltenitei', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-oltenitei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-oltenitei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-oltenitei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-rahova', '/decoratiuni-baloane-rahova/', 'location', 'Decoratiuni Baloane Rahova', 'Decoratiuni Baloane Rahova', 'Decoratiuni Baloane Rahova - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane rahova', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-rahova', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-rahova', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-rahova', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-cotroceni', '/decoratiuni-baloane-cotroceni/', 'location', 'Decoratiuni Baloane Cotroceni', 'Decoratiuni Baloane Cotroceni', 'Decoratiuni Baloane Cotroceni - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane cotroceni', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-cotroceni', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-cotroceni', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-cotroceni', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-13-septembrie', '/decoratiuni-baloane-13-septembrie/', 'location', 'Decoratiuni Baloane 13 Septembrie', 'Decoratiuni Baloane 13 Septembrie', 'Decoratiuni Baloane 13 Septembrie - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane 13 septembrie', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-13-septembrie', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-13-septembrie', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-13-septembrie', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-ferentari', '/decoratiuni-baloane-ferentari/', 'location', 'Decoratiuni Baloane Ferentari', 'Decoratiuni Baloane Ferentari', 'Decoratiuni Baloane Ferentari - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane ferentari', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-ferentari', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-ferentari', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-ferentari', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-sebastian', '/decoratiuni-baloane-sebastian/', 'location', 'Decoratiuni Baloane Sebastian', 'Decoratiuni Baloane Sebastian', 'Decoratiuni Baloane Sebastian - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane sebastian', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-sebastian', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-sebastian', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-sebastian', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-drumul-taberei', '/decoratiuni-baloane-drumul-taberei/', 'location', 'Decoratiuni Baloane Drumul Taberei', 'Decoratiuni Baloane Drumul Taberei', 'Decoratiuni Baloane Drumul Taberei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane drumul taberei', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-drumul-taberei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-drumul-taberei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-drumul-taberei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-militari', '/decoratiuni-baloane-militari/', 'location', 'Decoratiuni Baloane Militari', 'Decoratiuni Baloane Militari', 'Decoratiuni Baloane Militari - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane militari', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-militari', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-militari', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-militari', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-crangasi', '/decoratiuni-baloane-crangasi/', 'location', 'Decoratiuni Baloane Crangasi', 'Decoratiuni Baloane Crangasi', 'Decoratiuni Baloane Crangasi - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane crangasi', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-crangasi', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-crangasi', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-crangasi', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-giulesti', '/decoratiuni-baloane-giulesti/', 'location', 'Decoratiuni Baloane Giulesti', 'Decoratiuni Baloane Giulesti', 'Decoratiuni Baloane Giulesti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane giulesti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-giulesti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-giulesti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-giulesti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-grozavesti', '/decoratiuni-baloane-grozavesti/', 'location', 'Decoratiuni Baloane Grozavesti', 'Decoratiuni Baloane Grozavesti', 'Decoratiuni Baloane Grozavesti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane grozavesti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-grozavesti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-grozavesti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-grozavesti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-ilfov', '/decoratiuni-baloane-ilfov/', 'location', 'Decoratiuni Baloane Ilfov', 'Decoratiuni Baloane Ilfov', 'Decoratiuni Baloane Ilfov - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane ilfov', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-ilfov', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-ilfov', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-ilfov', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-voluntari', '/decoratiuni-baloane-voluntari/', 'location', 'Decoratiuni Baloane Voluntari', 'Decoratiuni Baloane Voluntari', 'Decoratiuni Baloane Voluntari - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane voluntari', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-voluntari', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-voluntari', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-voluntari', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-pipera', '/decoratiuni-baloane-pipera/', 'location', 'Decoratiuni Baloane Pipera', 'Decoratiuni Baloane Pipera', 'Decoratiuni Baloane Pipera - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane pipera', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-pipera', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-pipera', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-pipera', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-otopeni', '/decoratiuni-baloane-otopeni/', 'location', 'Decoratiuni Baloane Otopeni', 'Decoratiuni Baloane Otopeni', 'Decoratiuni Baloane Otopeni - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane otopeni', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-otopeni', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-otopeni', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-otopeni', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-tunari', '/decoratiuni-baloane-tunari/', 'location', 'Decoratiuni Baloane Tunari', 'Decoratiuni Baloane Tunari', 'Decoratiuni Baloane Tunari - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane tunari', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-tunari', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-tunari', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-tunari', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-corbeanca', '/decoratiuni-baloane-corbeanca/', 'location', 'Decoratiuni Baloane Corbeanca', 'Decoratiuni Baloane Corbeanca', 'Decoratiuni Baloane Corbeanca - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane corbeanca', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-corbeanca', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-corbeanca', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-corbeanca', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-balotesti', '/decoratiuni-baloane-balotesti/', 'location', 'Decoratiuni Baloane Balotesti', 'Decoratiuni Baloane Balotesti', 'Decoratiuni Baloane Balotesti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane balotesti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-balotesti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-balotesti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-balotesti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-mogosoaia', '/decoratiuni-baloane-mogosoaia/', 'location', 'Decoratiuni Baloane Mogosoaia', 'Decoratiuni Baloane Mogosoaia', 'Decoratiuni Baloane Mogosoaia - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane mogosoaia', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-mogosoaia', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-mogosoaia', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-mogosoaia', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-chitila', '/decoratiuni-baloane-chitila/', 'location', 'Decoratiuni Baloane Chitila', 'Decoratiuni Baloane Chitila', 'Decoratiuni Baloane Chitila - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane chitila', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-chitila', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-chitila', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-chitila', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-chiajna', '/decoratiuni-baloane-chiajna/', 'location', 'Decoratiuni Baloane Chiajna', 'Decoratiuni Baloane Chiajna', 'Decoratiuni Baloane Chiajna - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane chiajna', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-chiajna', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-chiajna', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-chiajna', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-domnesti', '/decoratiuni-baloane-domnesti/', 'location', 'Decoratiuni Baloane Domnesti', 'Decoratiuni Baloane Domnesti', 'Decoratiuni Baloane Domnesti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane domnesti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-domnesti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-domnesti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-domnesti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-bragadiru', '/decoratiuni-baloane-bragadiru/', 'location', 'Decoratiuni Baloane Bragadiru', 'Decoratiuni Baloane Bragadiru', 'Decoratiuni Baloane Bragadiru - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane bragadiru', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-bragadiru', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-bragadiru', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-bragadiru', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-magurele', '/decoratiuni-baloane-magurele/', 'location', 'Decoratiuni Baloane Magurele', 'Decoratiuni Baloane Magurele', 'Decoratiuni Baloane Magurele - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane magurele', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-magurele', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-magurele', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-magurele', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-popesti-leordeni', '/decoratiuni-baloane-popesti-leordeni/', 'location', 'Decoratiuni Baloane Popesti Leordeni', 'Decoratiuni Baloane Popesti Leordeni', 'Decoratiuni Baloane Popesti Leordeni - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane popesti leordeni', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-popesti-leordeni', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-popesti-leordeni', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-popesti-leordeni', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-berceni-ilfov', '/decoratiuni-baloane-berceni-ilfov/', 'location', 'Decoratiuni Baloane Berceni Ilfov', 'Decoratiuni Baloane Berceni Ilfov', 'Decoratiuni Baloane Berceni Ilfov - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane berceni ilfov', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-berceni-ilfov', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-berceni-ilfov', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-berceni-ilfov', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-pantelimon-ilfov', '/decoratiuni-baloane-pantelimon-ilfov/', 'location', 'Decoratiuni Baloane Pantelimon Ilfov', 'Decoratiuni Baloane Pantelimon Ilfov', 'Decoratiuni Baloane Pantelimon Ilfov - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane pantelimon ilfov', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-pantelimon-ilfov', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-pantelimon-ilfov', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-pantelimon-ilfov', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-cernica', '/decoratiuni-baloane-cernica/', 'location', 'Decoratiuni Baloane Cernica', 'Decoratiuni Baloane Cernica', 'Decoratiuni Baloane Cernica - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane cernica', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-cernica', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-cernica', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-cernica', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-afumati', '/decoratiuni-baloane-afumati/', 'location', 'Decoratiuni Baloane Afumati', 'Decoratiuni Baloane Afumati', 'Decoratiuni Baloane Afumati - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane afumati', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-afumati', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-afumati', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-afumati', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-stefanestii-de-jos', '/decoratiuni-baloane-stefanestii-de-jos/', 'location', 'Decoratiuni Baloane Stefanestii De Jos', 'Decoratiuni Baloane Stefanestii De Jos', 'Decoratiuni Baloane Stefanestii De Jos - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane stefanestii de jos', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-stefanestii-de-jos', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-stefanestii-de-jos', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-stefanestii-de-jos', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-dascalu', '/decoratiuni-baloane-dascalu/', 'location', 'Decoratiuni Baloane Dascalu', 'Decoratiuni Baloane Dascalu', 'Decoratiuni Baloane Dascalu - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane dascalu', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-dascalu', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-dascalu', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-dascalu', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-snagov', '/decoratiuni-baloane-snagov/', 'location', 'Decoratiuni Baloane Snagov', 'Decoratiuni Baloane Snagov', 'Decoratiuni Baloane Snagov - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane snagov', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-snagov', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-snagov', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-snagov', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-clinceni', '/decoratiuni-baloane-clinceni/', 'location', 'Decoratiuni Baloane Clinceni', 'Decoratiuni Baloane Clinceni', 'Decoratiuni Baloane Clinceni - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane clinceni', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-clinceni', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-clinceni', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-clinceni', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-dragomiresti-vale', '/decoratiuni-baloane-dragomiresti-vale/', 'location', 'Decoratiuni Baloane Dragomiresti Vale', 'Decoratiuni Baloane Dragomiresti Vale', 'Decoratiuni Baloane Dragomiresti Vale - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane dragomiresti vale', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-dragomiresti-vale', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-dragomiresti-vale', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-dragomiresti-vale', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-jilava', '/decoratiuni-baloane-jilava/', 'location', 'Decoratiuni Baloane Jilava', 'Decoratiuni Baloane Jilava', 'Decoratiuni Baloane Jilava - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane jilava', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-jilava', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-jilava', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-jilava', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-1-decembrie', '/decoratiuni-baloane-1-decembrie/', 'location', 'Decoratiuni Baloane 1 Decembrie', 'Decoratiuni Baloane 1 Decembrie', 'Decoratiuni Baloane 1 Decembrie - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane 1 decembrie', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-1-decembrie', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-1-decembrie', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-1-decembrie', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('arcada-baloane-botez-bucuresti', '/arcada-baloane-botez-bucuresti/', 'satellite', 'Arcada Baloane Botez Bucuresti', 'Arcada Baloane Botez Bucuresti', 'Arcada Baloane Botez Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'arcada baloane botez bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for arcada-baloane-botez-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for arcada-baloane-botez-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for arcada-baloane-botez-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('arcada-baloane-majorat-bucuresti', '/arcada-baloane-majorat-bucuresti/', 'satellite', 'Arcada Baloane Majorat Bucuresti', 'Arcada Baloane Majorat Bucuresti', 'Arcada Baloane Majorat Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'arcada baloane majorat bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for arcada-baloane-majorat-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for arcada-baloane-majorat-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for arcada-baloane-majorat-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('arcada-baloane-nunta-bucuresti', '/arcada-baloane-nunta-bucuresti/', 'satellite', 'Arcada Baloane Nunta Bucuresti', 'Arcada Baloane Nunta Bucuresti', 'Arcada Baloane Nunta Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'arcada baloane nunta bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for arcada-baloane-nunta-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for arcada-baloane-nunta-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for arcada-baloane-nunta-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('panou-foto-baloane-botez-bucuresti', '/panou-foto-baloane-botez-bucuresti/', 'satellite', 'Panou Foto Baloane Botez Bucuresti', 'Panou Foto Baloane Botez Bucuresti', 'Panou Foto Baloane Botez Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'panou foto baloane botez bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for panou-foto-baloane-botez-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for panou-foto-baloane-botez-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for panou-foto-baloane-botez-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('panou-foto-baloane-majorat-bucuresti', '/panou-foto-baloane-majorat-bucuresti/', 'satellite', 'Panou Foto Baloane Majorat Bucuresti', 'Panou Foto Baloane Majorat Bucuresti', 'Panou Foto Baloane Majorat Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'panou foto baloane majorat bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for panou-foto-baloane-majorat-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for panou-foto-baloane-majorat-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for panou-foto-baloane-majorat-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('baloane-heliu-majorat-bucuresti', '/baloane-heliu-majorat-bucuresti/', 'satellite', 'Baloane Heliu Majorat Bucuresti', 'Baloane Heliu Majorat Bucuresti', 'Baloane Heliu Majorat Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane heliu majorat bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for baloane-heliu-majorat-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for baloane-heliu-majorat-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for baloane-heliu-majorat-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('baloane-heliu-aniversare-bucuresti', '/baloane-heliu-aniversare-bucuresti/', 'satellite', 'Baloane Heliu Aniversare Bucuresti', 'Baloane Heliu Aniversare Bucuresti', 'Baloane Heliu Aniversare Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane heliu aniversare bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for baloane-heliu-aniversare-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for baloane-heliu-aniversare-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for baloane-heliu-aniversare-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('buchete-baloane-aniversare-bucuresti', '/buchete-baloane-aniversare-bucuresti/', 'satellite', 'Buchete Baloane Aniversare Bucuresti', 'Buchete Baloane Aniversare Bucuresti', 'Buchete Baloane Aniversare Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'buchete baloane aniversare bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for buchete-baloane-aniversare-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for buchete-baloane-aniversare-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for buchete-baloane-aniversare-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-roz-auriu-bucuresti', '/decoratiuni-baloane-roz-auriu-bucuresti/', 'satellite', 'Decoratiuni Baloane Roz Auriu Bucuresti', 'Decoratiuni Baloane Roz Auriu Bucuresti', 'Decoratiuni Baloane Roz Auriu Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane roz auriu bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-roz-auriu-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-roz-auriu-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-roz-auriu-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('decoratiuni-baloane-alb-auriu-bucuresti', '/decoratiuni-baloane-alb-auriu-bucuresti/', 'satellite', 'Decoratiuni Baloane Alb Auriu Bucuresti', 'Decoratiuni Baloane Alb Auriu Bucuresti', 'Decoratiuni Baloane Alb Auriu Bucuresti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decoratiuni baloane alb auriu bucuresti', 'commercial')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for decoratiuni-baloane-alb-auriu-bucuresti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for decoratiuni-baloane-alb-auriu-bucuresti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for decoratiuni-baloane-alb-auriu-bucuresti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcat-costa-decoratiunile-cu-baloane', '/blog/cat-costa-decoratiunile-cu-baloane/', 'guide', 'Blogcat Costa Decoratiunile Cu Baloane', 'Blogcat Costa Decoratiunile Cu Baloane', 'Blogcat Costa Decoratiunile Cu Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cât costă decorațiunile cu baloane', 'informativ / preț')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcat-costa-decoratiunile-cu-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcat-costa-decoratiunile-cu-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcat-costa-decoratiunile-cu-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'gallery_4', 'Kassia Content Team', false, 5)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;

    -- PAGE: /blog/cat-costa-o-arcada-de-baloane/
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcat-costa-o-arcada-de-baloane', '/blog/cat-costa-o-arcada-de-baloane/', 'guide', 'Blogcat Costa O Arcada De Baloane', 'Blogcat Costa O Arcada De Baloane', 'Blogcat Costa O Arcada De Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cât costă o arcadă de baloane', 'informativ / preț serviciu')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcat-costa-o-arcada-de-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcat-costa-o-arcada-de-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcat-costa-o-arcada-de-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcat-costa-baloanele-cu-heliu', '/blog/cat-costa-baloanele-cu-heliu/', 'guide', 'Blogcat Costa Baloanele Cu Heliu', 'Blogcat Costa Baloanele Cu Heliu', 'Blogcat Costa Baloanele Cu Heliu - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cât costă baloanele cu heliu', 'informativ / preț produs')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcat-costa-baloanele-cu-heliu', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcat-costa-baloanele-cu-heliu', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcat-costa-baloanele-cu-heliu', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcat-costa-un-panou-foto-cu-baloane', '/blog/cat-costa-un-panou-foto-cu-baloane/', 'guide', 'Blogcat Costa Un Panou Foto Cu Baloane', 'Blogcat Costa Un Panou Foto Cu Baloane', 'Blogcat Costa Un Panou Foto Cu Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cât costă un panou foto cu baloane', 'informativ / preț serviciu')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcat-costa-un-panou-foto-cu-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcat-costa-un-panou-foto-cu-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcat-costa-un-panou-foto-cu-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcat-costa-un-decor-de-baloane-pentru-botez', '/blog/cat-costa-un-decor-de-baloane-pentru-botez/', 'guide', 'Blogcat Costa Un Decor De Baloane Pentru Botez', 'Blogcat Costa Un Decor De Baloane Pentru Botez', 'Blogcat Costa Un Decor De Baloane Pentru Botez - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cât costă decor baloane botez', 'informativ / preț eveniment')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcat-costa-un-decor-de-baloane-pentru-botez', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcat-costa-un-decor-de-baloane-pentru-botez', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcat-costa-un-decor-de-baloane-pentru-botez', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcat-costa-un-decor-de-baloane-pentru-nunta', '/blog/cat-costa-un-decor-de-baloane-pentru-nunta/', 'guide', 'Blogcat Costa Un Decor De Baloane Pentru Nunta', 'Blogcat Costa Un Decor De Baloane Pentru Nunta', 'Blogcat Costa Un Decor De Baloane Pentru Nunta - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cât costă decor baloane nuntă', 'informativ / preț eveniment')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcat-costa-un-decor-de-baloane-pentru-nunta', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcat-costa-un-decor-de-baloane-pentru-nunta', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcat-costa-un-decor-de-baloane-pentru-nunta', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogce-include-un-pachet-decor-baloane', '/blog/ce-include-un-pachet-decor-baloane/', 'guide', 'Blogce Include Un Pachet Decor Baloane', 'Blogce Include Un Pachet Decor Baloane', 'Blogce Include Un Pachet Decor Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'ce include un pachet decor baloane', 'informativ / decizie')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogce-include-un-pachet-decor-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogce-include-un-pachet-decor-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogce-include-un-pachet-decor-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcum-alegi-pachetul-de-decoratiuni-baloane', '/blog/cum-alegi-pachetul-de-decoratiuni-baloane/', 'guide', 'Blogcum Alegi Pachetul De Decoratiuni Baloane', 'Blogcum Alegi Pachetul De Decoratiuni Baloane', 'Blogcum Alegi Pachetul De Decoratiuni Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cum alegi pachetul de decorațiuni baloane', 'informativ / decizie')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcum-alegi-pachetul-de-decoratiuni-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcum-alegi-pachetul-de-decoratiuni-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcum-alegi-pachetul-de-decoratiuni-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcum-alegi-arcada-de-baloane', '/blog/cum-alegi-arcada-de-baloane/', 'guide', 'Blogcum Alegi Arcada De Baloane', 'Blogcum Alegi Arcada De Baloane', 'Blogcum Alegi Arcada De Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cum alegi arcada de baloane', 'ghid informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcum-alegi-arcada-de-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcum-alegi-arcada-de-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcum-alegi-arcada-de-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogarcada-baloane-organica-sau-clasica', '/blog/arcada-baloane-organica-sau-clasica/', 'guide', 'Blogarcada Baloane Organica Sau Clasica', 'Blogarcada Baloane Organica Sau Clasica', 'Blogarcada Baloane Organica Sau Clasica - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'arcadă baloane organică sau clasică', 'comparație')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogarcada-baloane-organica-sau-clasica', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogarcada-baloane-organica-sau-clasica', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogarcada-baloane-organica-sau-clasica', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogce-dimensiune-trebuie-sa-aiba-o-arcada-de-baloane', '/blog/ce-dimensiune-trebuie-sa-aiba-o-arcada-de-baloane/', 'guide', 'Blogce Dimensiune Trebuie Sa Aiba O Arcada De Baloane', 'Blogce Dimensiune Trebuie Sa Aiba O Arcada De Baloane', 'Blogce Dimensiune Trebuie Sa Aiba O Arcada De Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'dimensiune arcadă baloane', 'informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogce-dimensiune-trebuie-sa-aiba-o-arcada-de-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogce-dimensiune-trebuie-sa-aiba-o-arcada-de-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogce-dimensiune-trebuie-sa-aiba-o-arcada-de-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogunde-se-poate-monta-o-arcada-de-baloane', '/blog/unde-se-poate-monta-o-arcada-de-baloane/', 'guide', 'Blogunde Se Poate Monta O Arcada De Baloane', 'Blogunde Se Poate Monta O Arcada De Baloane', 'Blogunde Se Poate Monta O Arcada De Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'unde se poate monta o arcadă de baloane', 'logistic / informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogunde-se-poate-monta-o-arcada-de-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogunde-se-poate-monta-o-arcada-de-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogunde-se-poate-monta-o-arcada-de-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcat-rezista-o-arcada-de-baloane', '/blog/cat-rezista-o-arcada-de-baloane/', 'guide', 'Blogcat Rezista O Arcada De Baloane', 'Blogcat Rezista O Arcada De Baloane', 'Blogcat Rezista O Arcada De Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cât rezistă o arcadă de baloane', 'informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcat-rezista-o-arcada-de-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcat-rezista-o-arcada-de-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcat-rezista-o-arcada-de-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-arcada-baloane-pentru-evenimente', '/blog/idei-arcada-baloane-pentru-evenimente/', 'guide', 'Blogidei Arcada Baloane Pentru Evenimente', 'Blogidei Arcada Baloane Pentru Evenimente', 'Blogidei Arcada Baloane Pentru Evenimente - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei arcadă baloane evenimente', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-arcada-baloane-pentru-evenimente', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-arcada-baloane-pentru-evenimente', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-arcada-baloane-pentru-evenimente', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogbaloane-heliu-cat-rezista', '/blog/baloane-heliu-cat-rezista/', 'guide', 'Blogbaloane Heliu Cat Rezista', 'Blogbaloane Heliu Cat Rezista', 'Blogbaloane Heliu Cat Rezista - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane heliu cât rezistă', 'informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogbaloane-heliu-cat-rezista', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogbaloane-heliu-cat-rezista', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogbaloane-heliu-cat-rezista', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogbaloane-heliu-latex-sau-folie', '/blog/baloane-heliu-latex-sau-folie/', 'guide', 'Blogbaloane Heliu Latex Sau Folie', 'Blogbaloane Heliu Latex Sau Folie', 'Blogbaloane Heliu Latex Sau Folie - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane heliu latex sau folie', 'comparație')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogbaloane-heliu-latex-sau-folie', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogbaloane-heliu-latex-sau-folie', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogbaloane-heliu-latex-sau-folie', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcate-baloane-cu-heliu-sunt-necesare-pentru-o-camera', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcate-baloane-cu-heliu-sunt-necesare-pentru-o-camera', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcate-baloane-cu-heliu-sunt-necesare-pentru-o-camera', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcum-se-transporta-baloanele-cu-heliu', '/blog/cum-se-transporta-baloanele-cu-heliu/', 'guide', 'Blogcum Se Transporta Baloanele Cu Heliu', 'Blogcum Se Transporta Baloanele Cu Heliu', 'Blogcum Se Transporta Baloanele Cu Heliu - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cum se transportă baloanele cu heliu', 'logistic')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcum-se-transporta-baloanele-cu-heliu', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcum-se-transporta-baloanele-cu-heliu', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcum-se-transporta-baloanele-cu-heliu', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogbaloane-cu-heliu-pentru-copii-idei', '/blog/baloane-cu-heliu-pentru-copii-idei/', 'guide', 'Blogbaloane Cu Heliu Pentru Copii Idei', 'Blogbaloane Cu Heliu Pentru Copii Idei', 'Blogbaloane Cu Heliu Pentru Copii Idei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane cu heliu pentru copii idei', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogbaloane-cu-heliu-pentru-copii-idei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogbaloane-cu-heliu-pentru-copii-idei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogbaloane-cu-heliu-pentru-copii-idei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogbaloane-cu-heliu-pentru-majorat-idei', '/blog/baloane-cu-heliu-pentru-majorat-idei/', 'guide', 'Blogbaloane Cu Heliu Pentru Majorat Idei', 'Blogbaloane Cu Heliu Pentru Majorat Idei', 'Blogbaloane Cu Heliu Pentru Majorat Idei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane cu heliu pentru majorat idei', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogbaloane-cu-heliu-pentru-majorat-idei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogbaloane-cu-heliu-pentru-majorat-idei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogbaloane-cu-heliu-pentru-majorat-idei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-botez', '/blog/idei-decor-baloane-botez/', 'guide', 'Blogidei Decor Baloane Botez', 'Blogidei Decor Baloane Botez', 'Blogidei Decor Baloane Botez - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane botez', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-botez', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-botez', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-botez', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-mot-si-turta', '/blog/idei-decor-baloane-mot-si-turta/', 'guide', 'Blogidei Decor Baloane Mot Si Turta', 'Blogidei Decor Baloane Mot Si Turta', 'Blogidei Decor Baloane Mot Si Turta - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane moț și turtă', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-mot-si-turta', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-mot-si-turta', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-mot-si-turta', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-nunta', '/blog/idei-decor-baloane-nunta/', 'guide', 'Blogidei Decor Baloane Nunta', 'Blogidei Decor Baloane Nunta', 'Blogidei Decor Baloane Nunta - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane nuntă', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-nunta', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-nunta', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-nunta', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-cununie', '/blog/idei-decor-baloane-cununie/', 'guide', 'Blogidei Decor Baloane Cununie', 'Blogidei Decor Baloane Cununie', 'Blogidei Decor Baloane Cununie - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane cununie', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-cununie', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-cununie', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-cununie', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-majorat', '/blog/idei-decor-baloane-majorat/', 'guide', 'Blogidei Decor Baloane Majorat', 'Blogidei Decor Baloane Majorat', 'Blogidei Decor Baloane Majorat - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane majorat', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-majorat', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-majorat', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-majorat', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-aniversare-copii', '/blog/idei-decor-baloane-aniversare-copii/', 'guide', 'Blogidei Decor Baloane Aniversare Copii', 'Blogidei Decor Baloane Aniversare Copii', 'Blogidei Decor Baloane Aniversare Copii - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane aniversare copii', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-aniversare-copii', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-aniversare-copii', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-aniversare-copii', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-aniversare-adulti', '/blog/idei-decor-baloane-aniversare-adulti/', 'guide', 'Blogidei Decor Baloane Aniversare Adulti', 'Blogidei Decor Baloane Aniversare Adulti', 'Blogidei Decor Baloane Aniversare Adulti - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane aniversare adulți', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-aniversare-adulti', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-aniversare-adulti', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-aniversare-adulti', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-baby-shower', '/blog/idei-decor-baloane-baby-shower/', 'guide', 'Blogidei Decor Baloane Baby Shower', 'Blogidei Decor Baloane Baby Shower', 'Blogidei Decor Baloane Baby Shower - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane baby shower', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-baby-shower', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-baby-shower', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-baby-shower', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-gender-reveal', '/blog/idei-decor-baloane-gender-reveal/', 'guide', 'Blogidei Decor Baloane Gender Reveal', 'Blogidei Decor Baloane Gender Reveal', 'Blogidei Decor Baloane Gender Reveal - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane gender reveal', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-gender-reveal', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-gender-reveal', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-gender-reveal', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogidei-decor-baloane-corporate', '/blog/idei-decor-baloane-corporate/', 'guide', 'Blogidei Decor Baloane Corporate', 'Blogidei Decor Baloane Corporate', 'Blogidei Decor Baloane Corporate - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'idei decor baloane corporate', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogidei-decor-baloane-corporate', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogidei-decor-baloane-corporate', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogidei-decor-baloane-corporate', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcum-alegi-culorile-pentru-decorul-cu-baloane', '/blog/cum-alegi-culorile-pentru-decorul-cu-baloane/', 'guide', 'Blogcum Alegi Culorile Pentru Decorul Cu Baloane', 'Blogcum Alegi Culorile Pentru Decorul Cu Baloane', 'Blogcum Alegi Culorile Pentru Decorul Cu Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cum alegi culorile pentru decorul cu baloane', 'informativ / design')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcum-alegi-culorile-pentru-decorul-cu-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcum-alegi-culorile-pentru-decorul-cu-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcum-alegi-culorile-pentru-decorul-cu-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogdecor-baloane-roz-auriu-idei', '/blog/decor-baloane-roz-auriu-idei/', 'guide', 'Blogdecor Baloane Roz Auriu Idei', 'Blogdecor Baloane Roz Auriu Idei', 'Blogdecor Baloane Roz Auriu Idei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decor baloane roz auriu idei', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogdecor-baloane-roz-auriu-idei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogdecor-baloane-roz-auriu-idei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogdecor-baloane-roz-auriu-idei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogdecor-baloane-alb-auriu-idei', '/blog/decor-baloane-alb-auriu-idei/', 'guide', 'Blogdecor Baloane Alb Auriu Idei', 'Blogdecor Baloane Alb Auriu Idei', 'Blogdecor Baloane Alb Auriu Idei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decor baloane alb auriu idei', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogdecor-baloane-alb-auriu-idei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogdecor-baloane-alb-auriu-idei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogdecor-baloane-alb-auriu-idei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogdecor-baloane-pastel-idei', '/blog/decor-baloane-pastel-idei/', 'guide', 'Blogdecor Baloane Pastel Idei', 'Blogdecor Baloane Pastel Idei', 'Blogdecor Baloane Pastel Idei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decor baloane pastel idei', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogdecor-baloane-pastel-idei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogdecor-baloane-pastel-idei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogdecor-baloane-pastel-idei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogdecor-baloane-luxury-idei', '/blog/decor-baloane-luxury-idei/', 'guide', 'Blogdecor Baloane Luxury Idei', 'Blogdecor Baloane Luxury Idei', 'Blogdecor Baloane Luxury Idei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decor baloane luxury idei', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogdecor-baloane-luxury-idei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogdecor-baloane-luxury-idei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogdecor-baloane-luxury-idei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogdecor-baloane-minimalist-sau-spectaculos', '/blog/decor-baloane-minimalist-sau-spectaculos/', 'guide', 'Blogdecor Baloane Minimalist Sau Spectaculos', 'Blogdecor Baloane Minimalist Sau Spectaculos', 'Blogdecor Baloane Minimalist Sau Spectaculos - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decor baloane minimalist sau spectaculos', 'comparație / inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogdecor-baloane-minimalist-sau-spectaculos', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogdecor-baloane-minimalist-sau-spectaculos', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogdecor-baloane-minimalist-sau-spectaculos', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcum-comanzi-decoratiuni-cu-baloane', '/blog/cum-comanzi-decoratiuni-cu-baloane/', 'guide', 'Blogcum Comanzi Decoratiuni Cu Baloane', 'Blogcum Comanzi Decoratiuni Cu Baloane', 'Blogcum Comanzi Decoratiuni Cu Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cum comanzi decorațiuni cu baloane', 'logistic / conversie')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcum-comanzi-decoratiuni-cu-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcum-comanzi-decoratiuni-cu-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcum-comanzi-decoratiuni-cu-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcu-cat-timp-inainte-se-comanda-decorul-cu-baloane', '/blog/cu-cat-timp-inainte-se-comanda-decorul-cu-baloane/', 'guide', 'Blogcu Cat Timp Inainte Se Comanda Decorul Cu Baloane', 'Blogcu Cat Timp Inainte Se Comanda Decorul Cu Baloane', 'Blogcu Cat Timp Inainte Se Comanda Decorul Cu Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cu cât timp înainte se comandă decorul cu baloane', 'logistic')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcu-cat-timp-inainte-se-comanda-decorul-cu-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcu-cat-timp-inainte-se-comanda-decorul-cu-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcu-cat-timp-inainte-se-comanda-decorul-cu-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogce-informatii-trebuie-sa-trimiti-pentru-o-oferta', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogce-informatii-trebuie-sa-trimiti-pentru-o-oferta', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogce-informatii-trebuie-sa-trimiti-pentru-o-oferta', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcum-se-face-montajul-decoratiunilor-cu-baloane', '/blog/cum-se-face-montajul-decoratiunilor-cu-baloane/', 'guide', 'Blogcum Se Face Montajul Decoratiunilor Cu Baloane', 'Blogcum Se Face Montajul Decoratiunilor Cu Baloane', 'Blogcum Se Face Montajul Decoratiunilor Cu Baloane - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'montaj decorațiuni baloane', 'logistic / informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcum-se-face-montajul-decoratiunilor-cu-baloane', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcum-se-face-montajul-decoratiunilor-cu-baloane', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcum-se-face-montajul-decoratiunilor-cu-baloane', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogse-pot-monta-decoratiuni-cu-baloane-in-exterior', '/blog/se-pot-monta-decoratiuni-cu-baloane-in-exterior/', 'guide', 'Blogse Pot Monta Decoratiuni Cu Baloane In Exterior', 'Blogse Pot Monta Decoratiuni Cu Baloane In Exterior', 'Blogse Pot Monta Decoratiuni Cu Baloane In Exterior - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'decorațiuni baloane exterior', 'logistic / informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogse-pot-monta-decoratiuni-cu-baloane-in-exterior', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogse-pot-monta-decoratiuni-cu-baloane-in-exterior', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogse-pot-monta-decoratiuni-cu-baloane-in-exterior', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogce-se-intampla-cu-decorul-dupa-eveniment', '/blog/ce-se-intampla-cu-decorul-dupa-eveniment/', 'guide', 'Blogce Se Intampla Cu Decorul Dupa Eveniment', 'Blogce Se Intampla Cu Decorul Dupa Eveniment', 'Blogce Se Intampla Cu Decorul Dupa Eveniment - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'ce se întâmplă cu decorul după eveniment', 'logistic / informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogce-se-intampla-cu-decorul-dupa-eveniment', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogce-se-intampla-cu-decorul-dupa-eveniment', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogce-se-intampla-cu-decorul-dupa-eveniment', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogpanou-foto-cu-baloane-idei-si-recomandari', '/blog/panou-foto-cu-baloane-idei-si-recomandari/', 'guide', 'Blogpanou Foto Cu Baloane Idei Si Recomandari', 'Blogpanou Foto Cu Baloane Idei Si Recomandari', 'Blogpanou Foto Cu Baloane Idei Si Recomandari - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'panou foto cu baloane idei', 'informativ / inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogpanou-foto-cu-baloane-idei-si-recomandari', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogpanou-foto-cu-baloane-idei-si-recomandari', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogpanou-foto-cu-baloane-idei-si-recomandari', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcandy-bar-cu-decor-de-baloane-idei', '/blog/candy-bar-cu-decor-de-baloane-idei/', 'guide', 'Blogcandy Bar Cu Decor De Baloane Idei', 'Blogcandy Bar Cu Decor De Baloane Idei', 'Blogcandy Bar Cu Decor De Baloane Idei - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'candy bar cu decor de baloane idei', 'inspirațional')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcandy-bar-cu-decor-de-baloane-idei', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcandy-bar-cu-decor-de-baloane-idei', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcandy-bar-cu-decor-de-baloane-idei', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogfoto-corner-cu-baloane-pentru-evenimente', '/blog/foto-corner-cu-baloane-pentru-evenimente/', 'guide', 'Blogfoto Corner Cu Baloane Pentru Evenimente', 'Blogfoto Corner Cu Baloane Pentru Evenimente', 'Blogfoto Corner Cu Baloane Pentru Evenimente - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'foto corner cu baloane pentru evenimente', 'inspirațional / informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogfoto-corner-cu-baloane-pentru-evenimente', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogfoto-corner-cu-baloane-pentru-evenimente', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogfoto-corner-cu-baloane-pentru-evenimente', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogcifre-si-litere-din-baloane-cand-se-folosesc', '/blog/cifre-si-litere-din-baloane-cand-se-folosesc/', 'guide', 'Blogcifre Si Litere Din Baloane Cand Se Folosesc', 'Blogcifre Si Litere Din Baloane Cand Se Folosesc', 'Blogcifre Si Litere Din Baloane Cand Se Folosesc - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'cifre și litere din baloane', 'informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogcifre-si-litere-din-baloane-cand-se-folosesc', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogcifre-si-litere-din-baloane-cand-se-folosesc', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogcifre-si-litere-din-baloane-cand-se-folosesc', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogbuchete-baloane-cand-se-potrivesc', '/blog/buchete-baloane-cand-se-potrivesc/', 'guide', 'Blogbuchete Baloane Cand Se Potrivesc', 'Blogbuchete Baloane Cand Se Potrivesc', 'Blogbuchete Baloane Cand Se Potrivesc - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'buchete baloane când se potrivesc', 'informativ')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogbuchete-baloane-cand-se-potrivesc', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogbuchete-baloane-cand-se-potrivesc', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogbuchete-baloane-cand-se-potrivesc', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
    ...
    INSERT INTO kassia_pages (slug, path, page_type, title, h1, meta_title, meta_description, canonical_url, priority, status, index_status, include_in_sitemap, main_keyword, search_intent)
    VALUES ('blogbaloane-personalizate-pentru-evenimente', '/blog/baloane-personalizate-pentru-evenimente/', 'guide', 'Blogbaloane Personalizate Pentru Evenimente', 'Blogbaloane Personalizate Pentru Evenimente', 'Blogbaloane Personalizate Pentru Evenimente - Kassia', '', NULL, 0.5, 'draft', 'noindex', false, 'baloane personalizate pentru evenimente', 'informativ / comercial suport')
    ON CONFLICT (path) DO UPDATE SET
        page_type = EXCLUDED.page_type,
        main_keyword = EXCLUDED.main_keyword,
        search_intent = EXCLUDED.search_intent
    ...
    ON CONFLICT ON CONSTRAINT unique_page_section DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 1 for blogbaloane-personalizate-pentru-evenimente', 'Placeholder', 1, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 2 for blogbaloane-personalizate-pentru-evenimente', 'Placeholder', 2, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_faqs (page_id, question, answer, sort_order, include_in_schema)
    VALUES (v_page_id, 'Draft FAQ 3 for blogbaloane-personalizate-pentru-evenimente', 'Placeholder', 3, false)
    ON CONFLICT ON CONSTRAINT unique_page_faq DO NOTHING;
    INSERT INTO kassia_gallery_items (page_id, slot_key, label_owner, is_required, sort_order)
    VALUES (v_page_id, 'hero_image', 'Kassia Content Team', true, 1)
    ON CONFLICT ON CONSTRAINT unique_page_slot DO NOTHING;
