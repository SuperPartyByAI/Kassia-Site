...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preflight_v5_7.json'), JSON.stringify(preflightData, null, 2));

let preflightMd = `# Kassia Seed Preflight V5.7\n\n`;
...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preflight_v5_7.md'), preflightMd);
...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preview_from_skeleton_v5_7.json'), JSON.stringify(previewData, null, 2));

let mdContent = `# Kassia Seed Preview V5.7 (169 Pages)\n\n`;
...
fs.writeFileSync(path.join(docsDir, 'kassia_seed_preview_from_skeleton_v5_7.md'), mdContent);

// Generate SQL 04_seed_kassia_skeleton_preview_v5_7.sql
...
fs.writeFileSync('planned_links.json', JSON.stringify(links));


console.log(JSON.stringify(previewData.summary, null, 2));
fs.writeFileSync(path.join(docsDir, 'kassia_internal_link_graph_v5_7.json'), JSON.stringify(links, null, 2));
